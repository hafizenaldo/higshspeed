            ...
            <nav class="limiter-menu-desktop p-l-45">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li><a href="{{ url('product.html') }}">Shop</a></li>
                        <li class="label1" data-label1="hot"><a href="{{ url('shoping-cart.html') }}">Features</a></li>
                ...
                <div class="wrap-icon-header flex-w flex-r-m h-full">
                    ...
                    <div class="flex-c-m h-full p-lr-19">
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l
